      ...
      >
        <View className="mb-10">
            ...
            <Text className="text-3xl font-bold text-center text-gray-800 mb-2">
              SikadGo: A Smart Public Transport Booking and Surveillance System for Sustainable Urban Mobility
            </Text>
            
          <Text className="text-center text-black-500 mt-2">
        ...
        <View className="relative w-full h-auto flex flex-row mb-4">
            <View className="border border-gray-300 border-l-1 mr-[-3] rounded-tl-lg rounded-bl-lg justify-center items-center px-2">
                <Fontisto name="email" size={30} color="yellowgreen" />
            </View>
        ...
        <View className="relative w-full h-auto flex flex-row mb-4">
            <View className="border border-gray-300 border-l-1 mr-[-3] rounded-tl-lg rounded-bl-lg justify-center items-center px-2">
                <Fontisto name="locked" size={30} color="yellowgreen" />
            </View>
          <View className="flex-1 border border-gray-300 border-l-0 rounded-lg px-4 py-1">
            <TextInput
                value={password}
